<p align="center">
    <img src="https://alcomd.cqmhv.com/assets/logo.png" alt="ALCOMD3 標誌" width="160">
</p>
...
1. 前往 [ALCOMD3 官方網站](https://alcomd.cqmhv.com/)，選擇 stable 或 beta 頻道。
...
MCP 預設關閉。啟用後，它內建於 GUI 行程，並且只使用帶驗證的本機回送 Streamable HTTP
endpoint，不會啟動獨立 helper，也不會監聽區域網路或公網位址。用戶端仍預設由使用者手動設定；Windows 使用者可選擇讓
MCP 頁面快速設定 Codex。設定方式、可用工具和
...
開發環境需要 Rust stable toolchain、Node.js 24 及其隨附的 npm，以及目標平台所需的
建置工具。
