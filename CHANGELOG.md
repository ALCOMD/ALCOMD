...
- Counted failed package operations and repository downloads as processed in progress bars so finished operations reach 100%, moved repository progress to the concurrent preview download, reused that result for final saving instead of downloading twice, and kept cancellations at their actual progress.
