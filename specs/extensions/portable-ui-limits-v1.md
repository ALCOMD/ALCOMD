...
验证成本固定在小范围。单项文本 4 KiB，validation message 512 bytes，select 64 options，form 64 fields。所有尺寸按
canonical compact UTF-8
...
nodeId、fieldId、actionId、optionId 和作为 formId 的 form nodeId 按 ASCII bytes 计数，必须匹配
`^[a-z][a-z0-9._-]{0,63}$`。signed integer 限制在
