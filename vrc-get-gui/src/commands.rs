...
pub(crate) fn handlers() -> impl Fn(Invoke) -> bool + Send + Sync + 'static {
    generate_handler![
        ...
        environment::config::environment_log_view_preferences,
        environment::config::environment_set_log_view_preferences,
        ...
        environment::config::environment_mcp_localized_tool_names,
        environment::config::environment_set_mcp_localized_tool_names,
        ...
        discord_presence::unity_discord_set_display_options,
        mcp::mcp_status,
        mcp::mcp_set_enabled,
        ...
        environment::packages::environment_discard_repository_downloads,
